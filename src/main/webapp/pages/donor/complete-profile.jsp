...
<div class="auth-page">
    <div class="auth-card">
        <a href="${pageContext.request.contextPath}/" class="auth-logo" style="display: block; text-decoration: none;">
            ...
            <h1>EcoChain</h1>
            <p>Complete Your Donor Profile</p>
        </a>
        ...
        <form action="/donor/complete-profile" method="post">
            <input type="hidden" name="action" value="completeProfile"/>
            <div class="form-group">
                <label for="businessName">Business Name</label>
                <input type="text" id="businessName" name="businessName" placeholder="Restaurant / Store name" required/>
            </div>
            <div class="form-group">
                <label for="address">Address</label>
                <input type="text" id="address" name="address" placeholder="Business address" required/>
            </div>
            <div class="form-group">
                <label for="licenseNumber">License Number</label>
                <input type="text" id="licenseNumber" name="licenseNumber" placeholder="Business license number" required/>
            </div>
            <div class="form-group">
